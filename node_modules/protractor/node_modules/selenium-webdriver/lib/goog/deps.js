...
goog.addDependency("../webdriver/test/builder_test.js", [], ["goog.testing.jsunit","webdriver.Builder"]);
...
goog.addDependency("../webdriver/builder.js", ["webdriver.Builder"], ["goog.Uri","goog.userAgent","webdriver.Capabilities","webdriver.FirefoxDomExecutor","webdriver.WebDriver","webdriver.http.CorsClient","webdriver.http.Executor","webdriver.http.XhrClient"]);
...
goog.addDependency("../webdriver/capabilities.js", ["webdriver.Browser","webdriver.Capabilities","webdriver.Capability","webdriver.ProxyConfig"], ["webdriver.Serializable","webdriver.logging.Preferences"]);
goog.addDependency("../webdriver/serializable.js", ["webdriver.Serializable"], []);
goog.addDependency("../webdriver/logging.js", ["webdriver.logging","webdriver.logging.Preferences"], ["goog.object"]);
goog.addDependency("../webdriver/firefoxdomexecutor.js", ["webdriver.FirefoxDomExecutor"], ["bot.response","goog.json","goog.userAgent.product","webdriver.Command","webdriver.CommandExecutor","webdriver.CommandName"]);
...
goog.addDependency("../webdriver/touchsequence.js", ["webdriver.TouchSequence"], ["goog.array","webdriver.Command","webdriver.CommandName"]);
goog.addDependency("../webdriver/promise.js", ["webdriver.promise","webdriver.promise.ControlFlow","webdriver.promise.Deferred","webdriver.promise.Promise","webdriver.promise.Thenable"], ["goog.array","goog.async.run","goog.async.throwException","goog.debug.Error","goog.object","webdriver.EventEmitter","webdriver.stacktrace.Snapshot","webdriver.stacktrace"]);
...
goog.addDependency("../webdriver/http/corsclient.js", ["webdriver.http.CorsClient"], ["goog.json","webdriver.http.Client","webdriver.http.Response"]);
goog.addDependency("../webdriver/http/http.js", ["webdriver.http.Client","webdriver.http.Executor","webdriver.http.Request","webdriver.http.Response"], ["bot.ErrorCode","goog.array","goog.json","webdriver.CommandExecutor","webdriver.CommandName","webdriver.promise.Deferred"]);
goog.addDependency("../webdriver/http/xhrclient.js", ["webdriver.http.XhrClient"], ["goog.json","goog.net.XmlHttp","webdriver.http.Client","webdriver.http.Response"]);
...
goog.addDependency("../webdriver/test/testutil.js", ["webdriver.test.testutil","webdriver.test.testutil.StubError"], ["goog.array","goog.debug.Error","goog.json","goog.string","goog.testing.recordFunction","webdriver.stacktrace"]);
...
goog.addDependency("../webdriver/test/promise_error_test.js", [], ["goog.Promise","goog.async.run","goog.testing.jsunit","goog.userAgent","webdriver.promise","webdriver.test.testutil"]);
goog.addDependency("../webdriver/test/promise_flow_test.js", [], ["goog.array","goog.string","goog.testing.jsunit","goog.userAgent","webdriver.promise.ControlFlow","webdriver.stacktrace.Snapshot","webdriver.stacktrace","webdriver.test.testutil"]);
goog.addDependency("../webdriver/test/promise_test.js", [], ["goog.testing.MockClock","goog.testing.jsunit","goog.userAgent","webdriver.promise","webdriver.promise.Deferred","webdriver.stacktrace","webdriver.test.testutil"]);
...
goog.addDependency("../webdriver/test/testing/asserts_test.js", [], ["goog.testing.jsunit","goog.userAgent","webdriver.test.testutil","webdriver.testing.assert","webdriver.testing.asserts"]);
...
goog.addDependency("../webdriver/test/testing/testcase_test.js", [], ["goog.Promise","goog.testing.MockControl","goog.testing.PropertyReplacer","goog.testing.mockmatchers","goog.testing.jsunit","goog.testing.recordFunction","goog.userAgent","webdriver.test.testutil","webdriver.testing.TestCase"]);
...
goog.addDependency("useragent/product_isversion.js", ["goog.userAgent.product.isVersion"], ["goog.string","goog.userAgent","goog.userAgent.product"]);
...
goog.addDependency("../webdriver/test/promise_generator_test.js", ["webdriver.test.promise.generator.test"], ["goog.testing.jsunit","webdriver.promise"]);
goog.addDependency("../webdriver/test/until_test.js", ["webdriver.test.until_test"], ["bot.Error","bot.ErrorCode","bot.response","goog.array","goog.string","goog.testing.jsunit","goog.userAgent","webdriver.By","webdriver.CommandName","webdriver.WebDriver","webdriver.WebElement","webdriver.WebElementPromise","webdriver.until"]);
goog.addDependency("../webdriver/test/webdriver_generator_test.js", ["webdriver.test.WebDriver.generator.test"], ["goog.testing.jsunit","webdriver.Session","webdriver.WebDriver"]);
